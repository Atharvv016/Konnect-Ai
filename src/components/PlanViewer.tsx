...
import { CheckCircle2, GitBranch, FileText, MessageSquare, Search, LayoutDashboard, Circle, Loader2, Mail, Calendar, Database, Eye, Activity, BookOpen } from 'lucide-react';
...
const getSystemIcon = (system: SystemType) => {
  ...
  switch (system) {
    ...
    case SystemType.CALENDAR: return <Calendar className="w-4 h-4 text-zinc-300" />;
    case SystemType.DATABASE: return <Database className="w-4 h-4 text-zinc-300" />;
