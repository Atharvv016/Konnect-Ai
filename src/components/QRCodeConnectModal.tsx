      ...
      <div className="bg-zinc-950 border border-white/10 rounded-3xl max-w-sm w-full shadow-2xl overflow-hidden relative ring-1 ring-white/5">
        ...
        <div className="p-8 flex flex-col items-center text-center space-y-6">
          ...
          <div className="relative p-4 bg-white/5 rounded-2xl border border-white/10 shadow-inner group">
             ...
             <div className="absolute inset-0 bg-zinc-500/10 blur-2xl rounded-full opacity-0 group-hover:opacity-30 transition-opacity duration-700" />
             <div className="absolute -inset-1 bg-gradient-to-tr from-zinc-400/10 to-transparent opacity-10 blur-lg rounded-3xl" />
          </div>
          ...
          <div className="w-full bg-zinc-900/50 rounded-xl p-3 border border-white/5 flex items-center justify-between">
            <div className="text-left">
              ...
              <div className="text-sm font-mono text-white font-medium tracking-wide">{sessionId}</div>
            </div>
            <button 
              onClick={handleCopy}
